...
import com.anjieyang.uooj.dao.user.impl.UserInfoEntityServiceImpl;
import com.anjieyang.uooj.dao.user.impl.UserRoleEntityServiceImpl;
import com.anjieyang.uooj.mapper.*;
...
import com.anjieyang.uooj.dao.common.impl.AnnouncementEntityServiceImpl;
import com.anjieyang.uooj.dao.discussion.impl.DiscussionEntityServiceImpl;
import com.anjieyang.uooj.dao.problem.impl.LanguageEntityServiceImpl;
import com.anjieyang.uooj.utils.IpUtils;
import com.anjieyang.uooj.utils.JsoupUtils;
...
public class DataBackupApplicationTests {
    ...
    @Test
    public void Test1() {
        String uooj123456 = SecureUtil.md5("uooj123456");
        System.out.println(uooj123456);
    }
    ...
    public void Test2() {
        ...
        try {
            // 获取该微服务的所有健康实例
            List<Instance> instances = namingService.selectInstances("uooj-judge-server", true);
