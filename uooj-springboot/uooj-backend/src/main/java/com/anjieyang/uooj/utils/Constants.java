...
public class Constants {
    ...
    public enum File {
        ...
        USER_AVATAR_FOLDER("/uooj/file/avatar"),

        GROUP_AVATAR_FOLDER("/uooj/file/avatar/group"),

        HOME_CAROUSEL_FOLDER("/uooj/file/carousel"),

        MARKDOWN_FILE_FOLDER("/uooj/file/md"),

        PROBLEM_FILE_FOLDER("/uooj/file/problem"),

        CONTEST_TEXT_PRINT_FOLDER("/uooj/file/contest_print"),

        IMG_API("/api/public/img/"),

        FILE_API("/api/public/file/"),

        TESTCASE_TMP_FOLDER("/uooj/file/zip"),

        TESTCASE_BASE_FOLDER("/uooj/testcase"),

        FILE_DOWNLOAD_TMP_FOLDER("/uooj/file/zip/download"),

        CONTEST_AC_SUBMISSION_TMP_FOLDER("/uooj/file/zip/contest_ac");
