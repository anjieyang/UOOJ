...
import com.anjieyang.uooj.common.exception.*;
import com.anjieyang.uooj.dao.user.UserAcproblemEntityService;
...
import com.anjieyang.uooj.validator.JudgeValidator;
...
import com.anjieyang.uooj.dao.judge.JudgeCaseEntityService;
import com.anjieyang.uooj.dao.judge.JudgeEntityService;
import com.anjieyang.uooj.dao.problem.ProblemEntityService;
import com.anjieyang.uooj.judge.remote.RemoteJudgeDispatcher;
import com.anjieyang.uooj.judge.self.JudgeDispatcher;
...
import com.anjieyang.uooj.pojo.entity.user.UserAcproblem;
    ...
    public SubmissionInfoVO getSubmission(Long submitId) throws StatusNotFoundException, StatusAccessDeniedException {
        ...
        if (judge.getCid() != 0) {
            ...
            if (!isRoot && contest.getIsGroup() && judge.getCode() != null) {
                try {
                    accessValidator.validateAccess(UOOJAccessEnum.HIDE_NON_CONTEST_SUBMISSION_CODE);
